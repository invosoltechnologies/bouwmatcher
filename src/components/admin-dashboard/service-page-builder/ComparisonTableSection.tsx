...
import { useSaveServicePageComparisonTable } from '@/lib/hooks/admin/service-page-comparison-tables';
import { ServicePageComparisonTableDTO } from '@/lib/api/admin/service-page-comparison-tables.api';

interface ComparisonTableSectionProps {
  servicePageId: string;
  initialData?: ServicePageComparisonTableDTO | null;
}
...
export default function ComparisonTableSection({
  ...
  const saveMutation = useSaveServicePageComparisonTable();
  ...
  const handleSave = async () => {
    try {
      ...
      console.error('Error saving comparison table section:', error);
    }
  };
    ...
    <Card className='py-0 border border-slate-200 rounded-lg overflow-hidden'>
      ...
      >
        <h3 className='text-lg font-semibold text-slate-900'>
          {locale === 'nl' ? 'Vergelijkingstabel Sectie' : 'Comparison Table Section'}
        </h3>
        {isExpanded ? (
          ...
          <div className='grid grid-cols-2 gap-6'>
            ...
            <div className='space-y-4 p-4 bg-white rounded-lg border border-slate-200'>
              ...
              <div className='space-y-2'>
                ...
                <Input
                  placeholder='bijv. Vergelijkingstabel'
                  value={headingNl}
              ...
              <div className='space-y-2'>
                ...
                <TinyMCEEditor
                  ...
                  placeholder='Maak een tabel met vergelijkingsgegevens...'
            ...
            <div className='space-y-4 p-4 bg-white rounded-lg border border-slate-200'>
              ...
              <div className='space-y-2'>
                ...
                <TinyMCEEditor
                  ...
                  placeholder='Create a table with comparison data...'
                  className='bg-slate-50'
                />
                <p className='text-xs text-slate-400 mt-1'>
                  {locale === 'nl'
