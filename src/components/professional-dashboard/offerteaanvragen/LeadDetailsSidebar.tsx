          ...
          <CardContent className='pt-6'>
            ...
            <div className='space-y-3'>
              <div>
                ...
                <Badge
                  className={`${getProjectStatusInfo(status, isAssignedToMe).color} px-3 py-1 text-sm font-medium`}
                >
...
{/* test */}
      ...
      {/* Help Card */}
      <HelpSupportCard translationNamespace="common.proDashboard.offerteaanvragen.leadDetailsSidebar" />
    </div>
  );
}
